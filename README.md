...
> **This project is no longer being maintained.** Watch the [postal.js](https://github.com/postaljs/postal.js) repo for the release of v3, which will provide cross-frame communications using modern browser APIs.
